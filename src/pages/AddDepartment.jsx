...
const AddDepartment = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-white via-gray-100 to-gray-200 text-gray-800">
      <Sidebar />
      <main className="flex-1 p-4 sm:p-6 md:p-8 bg-gray-100 bg-opacity-95 md:rounded-tl-3xl relative overflow-auto">
...
export default React.memo(AddDepartment); // Memoize to prevent unnecessary re-renders