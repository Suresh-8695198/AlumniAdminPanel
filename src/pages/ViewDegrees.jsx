...
const mockDegrees = {
  CS001: [
    { id: 1, name: "MCA", duration_years: 2 },
    { id: 2, name: "BSc CS", duration_years: 3 },
  ],
  TM001: [
    { id: 3, name: "MA Tamil", duration_years: 2 },
  ],
  SC001: [],
};
...
const ViewDegrees = () => {
  ...
  useEffect(() => {
    ...
    const departmentDegrees = mockDegrees[departmentId] || [];
    console.log('Degrees for', departmentId, ':', departmentDegrees);
    setDegrees(departmentDegrees);
  }, [departmentId]);
