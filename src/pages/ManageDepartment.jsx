...
const mockDepartments = [
  { department_id: "CS001", department_name: "Computer Science", email: "cs@college.edu" },
  { department_id: "TM001", department_name: "Tamil", email: "tamil@college.edu" },
  { department_id: "SC001", department_name: "Science", email: "science@college.edu" },
];
...
const ManageDepartment = () => {
  ...
  useEffect(() => {
    console.log('Setting departments:', JSON.stringify(mockDepartments, null, 2));
    const validDepartments = mockDepartments.filter(
